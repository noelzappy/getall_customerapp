...
class _LoginScreenState extends State<LoginScreen> {
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: button2(
                                strings.get(46), theme.mainColor, _login),
                          ...
                          Container(
                            margin: EdgeInsets.all(20),
                            child: button2(strings.get(47), theme.mainColor,
                          ...
                          if (Platform.isIOS)
                            buttonIOS("assets/apple.png", _appleLogin,
                                windowWidth * 0.9, "Sign in with Apple"),
                          SizedBox(
                            height: 10,
                          ),
                          ...
                          Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Flexible(
                                      child: button196("Google",
                                          theme.mainColor, _googleLogin,
                                          style: theme.style16W800White)),
                                ],
                              ))
                        ],
  ...
  _login() async {
    if (_editControllerEmail.text.isEmpty)
      return messageError(context, strings.get(135));
    ...
    if (getProviderByEmail(_editControllerEmail.text) != null)
      return messageError(context, strings.get(288));

    /// "Provider can't enter to customer app. Please use another credentials.",

    _waits(true);
    var ret = await login(
        _editControllerEmail.text,
        _editControllerPassword.text,
        true,
